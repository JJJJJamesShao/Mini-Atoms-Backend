...
export const DEFAULT_SOP: SOPConfig = {
  ...
  steps: [
    ...
    },
    {
      ...
      next: {
        default: 'generate',
        conditions: [{ field: 'exhausted', operator: 'eq', value: 'true', then: 'fail' }],
      },
    },
  ...
  steps: [
    ...
    },
    {
      ...
      next: {
        ...
        conditions: [{ field: 'pass', operator: 'eq', value: 'false', then: 'fix-schema' }],
      },
    },
    {
      name: 'fix-schema',
    ...
    },
    {
      ...
      next: {
        ...
        conditions: [{ field: 'pass', operator: 'eq', value: 'false', then: 'fix-shell' }],
      },
    },
    {
      name: 'fix-shell',
    ...
    },
    {
      ...
      next: {
        default: 'merge',
        conditions: [{ field: 'pass', operator: 'eq', value: 'false', then: 'fix-pages' }],
      },
    },
    {
      name: 'fix-pages',
...
export const MODIFY_SOP: SOPConfig = {
  ...
  steps: [
    ...
    { name: 'patch', role: 'engineer', action: 'patch', next: 'apply' },
    {
      ...
      next: {
        default: 'verify',
        conditions: [{ field: 'pass', operator: 'eq', value: 'false', then: 'fix-patch' }],
      },
    },
    {
      name: 'verify',
